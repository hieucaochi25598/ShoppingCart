                    ...
                    <tbody>
                        {this.props.mangSV.map(sv => (
                            <tr>
                                ...
                                <td>{sv.email}</td>
                                <td>
                                    <button className="btn btn-primary" onClick={() => {this.props.chonSinhVien(sv); this.props.onToggle(true)}}>Edit</button>
                                    <button onClick={() => this.props.xoaSinhVien(sv.maSV)} className="btn btn-danger">Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
